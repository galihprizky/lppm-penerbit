...
let RolesController = class RolesController {
    ...
    async create(createRoleDto) {
        ...
        return this.buildResponse(common_1.HttpStatus.CREATED, 'Role berhasil dibuat', data);
    }
    async findAll() {
    ...
    async findOne(id) {
        ...
        return this.buildResponse(common_1.HttpStatus.OK, 'Detail role berhasil diambil', data);
    }
    async update(id, updateRoleDto) {
        const data = await this.rolesService.update(id, updateRoleDto);
        return this.buildResponse(common_1.HttpStatus.OK, 'Role berhasil diperbarui', data);
    }
    async remove(id) {
        const data = await this.rolesService.remove(id);
        return this.buildResponse(common_1.HttpStatus.OK, 'Role berhasil dihapus', data);
    }
};
